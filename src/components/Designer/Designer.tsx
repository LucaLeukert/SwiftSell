import { NarrowSidebar } from "~/components/Designer/NarrowSidebar";
import { Inspector } from "~/components/Designer/Inspector";
import { BlocksGallery } from "~/components/Designer/BlockGallery";
import React, { useEffect, useState } from "react";
import renderHandlebar from "~/utils/handlebars";
import { api } from "~/utils/api";
import Head from "next/head";
import { BlockSearch } from "~/components/Designer/BlockSearch";
import { BsPhone, BsPhoneLandscape, BsTabletLandscape, HiOutlineDesktopComputer } from "react-icons/all";
