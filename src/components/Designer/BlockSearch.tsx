...
import { BlockPreview } from "~/components/Designer/BlockPreview";
...
export const BlockSearch = (props: {
    ...
    return (
      <div className="flex h-full w-full flex-col px-2 pb-2">
          ...
          <div
            className="flex flex-col gap-5 overflow-y-scroll pr-2 scrollbar scrollbar-track-gray-100 scrollbar-thumb-slate-500 scrollbar-thumb-rounded">
              {blocks
                .filter((block) => {
